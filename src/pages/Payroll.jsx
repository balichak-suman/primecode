      ...
      <div className="hr-payroll-view">
        ...
        {step === 4 && (
          <div className="glass-card" style={{ padding: '3rem', textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 200px), 1fr))', gap: '2rem', margin: '2rem 0' }}>
               <div className="glass-card" style={{ padding: '1.5rem' }}>
      ...
      <div className="admin-payroll-view">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 250px), 1fr))', gap: '2rem' }}>
          ...
          <div className="glass-card" style={{ padding: '2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 250px), 1fr))', gap: '1rem', marginTop: '1.5rem' }}>
