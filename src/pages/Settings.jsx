      ...
      <div style={{ flex: 1, maxWidth: '720px' }}>
        ...
        {activeTab === 'holidays' && (
          <Section title="Holiday Calendar" icon={Calendar}>
            ...
            <div className="glass-card" style={{ padding: '1rem', marginBottom: '1.5rem', border: '1px solid rgba(0,210,255,0.1)' }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 150px), 1fr))', gap: '8px', marginBottom: '8px' }}>
        ...
        {activeTab === 'leave' && (
          <Section title="Leave Policy Editor" icon={FileText}>
            <div className="glass-card" style={{ padding: '1rem', marginBottom: '1.5rem', border: '1px solid rgba(0,210,255,0.1)' }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 120px), 1fr))', gap: '8px', marginBottom: '8px' }}>
